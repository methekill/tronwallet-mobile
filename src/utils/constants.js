...
export const FIXED_TOKENS = ['TRX', 'TWX', 'LoveHearts', 'CyberTron', 'IGG', 'Alivio', 'ReynaToken', 'BeatzCoin']
export const FEATURED_TOKENS = ['TWX', 'LoveHearts', 'CyberTron']
export const VERIFIED_TOKENS = ['TWX', 'LoveHearts', 'CyberTron', 'IGG', 'Alivio', 'ReynaToken', 'BeatzCoin']
